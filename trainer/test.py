...
from model_legacy import DFNet
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-m', '--model', default='C:/Users/sohail/DFNet_TF2/trainer/ckpt',
    ...
    parser.add_argument(
        ...
        help='Batch size for testing.')
    parser.add_argument(
        '--img', default='C:/Users/sohail/DFNet_TF2/samples/celeba/img',
        help='Image or Image folder.')
    parser.add_argument(
        '--mask', default='C:/Users/sohail/DFNet_TF2/samples/celeba/mask',
        help='Mask or Mask folder.')
    parser.add_argument('--output', default='C:/Users/sohail/DFNet_TF2/output/celeba',
        help='Output dir')
    parser.add_argument(
